...
void block_init(struct block_t *block, block_type_t type) {
    ...
    block->vertices[3] = ((620 % 32) + 1.0f) / 32.0;
    block->vertices[4] = ((672 / 32.0) + 1.0f) / 32.0;
    ...
    block->vertices[13] = ((620 % 32) + 0.0f) / 32.0;
    block->vertices[14] = ((672 / 32.0) + 0.0f) / 32.0;
    block->vertices[15] = -0.5f; 
    block->vertices[16] = -0.5f; 
    block->vertices[17] = -0.5f; 
    block->vertices[18] = ((620 % 32) + 0.0f) / 32.0;
    block->vertices[19] = ((672 / 32.0) + 0.0f) / 32.0;
    ...
    block->vertices[28] = ((620 % 32) + 1.0f) / 32.0;
    block->vertices[29] = ((672 / 32.0) + 1.0f) / 32.0;
